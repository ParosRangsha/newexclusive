        ...
        <div className="flex">
          <div className="sidemenu py-[40px] pr-2 w-[15%] border-r-[1px]">
            ...
            <ul className="flex flex-col py-[20px] h-[500px] overflow-y-scroll">
              {category.map((item, i) => (
                <li key={i}>
                  <Link to='/shop' className="py-[5px] flex justify-between items-center hover:bg-[#db4444] hover:text-[#fff] duration-[1s] hover:px-[15px] cursor-pointer">
                    {item.slice(0, 10).toUpperCase()}
                    <IoIosArrowForward />
                  </Link>
                </li>
              ))}
                  ...
                  <div className="slideitem w-full bg-[#000] text-[#fff] flex">
                    <div className="sidetext w-1/2 p-[58px]">
                      ...
                      <h1 className="text-[48px] font-semibold">
                        Up to {Math.floor(item.discountPercentage)}% off Voucher
                      </h1>
                      <div className="flex items-center gap-3 py-[10px]">
                        <Link
                          to="/shop"
                          className='inline-block items-center gap-3 relative after:absolute after:contents-[""] after:h-[3px] after:w-full after:bg-[#fff] after:top-full after:left-0 bg-[#333] hover:bg-[#555] py-[10px] px-[15px] duration-[1s]'
                        >
                          Shop Now{" "}
                        </Link>
                      </div>
