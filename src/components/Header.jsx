      ...
      <div className="noticeboard w-full bg-[#000] text-[#fff] py-[15px] flex items-center">
        ...
        <div className="lang">
          <select
            name="language"
            id="laguage"
            className="bg-[#000] border-[1px] border-[#fff] rounded-[3px]"
          >
            ...
            <ul className="flex justify-between">
              {myMenu.map((item, i) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? 'bg-[#db4444] px-[15px] py-[10px] cursor-pointer hover:bg-[#f5f5f5] duration-[1s] relative after:absolute after:contents-[""] after:h-[5px] after:w-0 after:bg-[#f00] after:left-0 after:bottom-0 after:opacity-0 hover:after:opacity-[100%] after:duration-[1s] hover:after:w-full'
                      : 'bg-[#fff] px-[15px] py-[10px] cursor-pointer hover:bg-[#f5f5f5] duration-[1s] relative after:absolute after:contents-[""] after:h-[5px] after:w-0 after:bg-[#f00] after:left-0 after:bottom-0 after:opacity-0 hover:after:opacity-[100%] after:duration-[1s] hover:after:w-full'
                  }
                >
                  {item}
                </NavLink>
          ...
          <div className="icons flex items-center gap-3">
            <div className="search relative">
              <input
                ...
                className="p-[10px] bg-[#f5f5f5] rounded-[5px]"
              />
              <FaSearch className="absolute right-[10px] top-[50%] translate-y-[-50%]" />
              <div
                className={`${
                  searchShow.length > 0 ? "block" : "hidden"
                } popup w-full absolute top-[100%] left-0 bg-[#db4444] overflow-y-scroll h-[350px] `}
              >
                <ul>
                  {searchShow.map((item, i) => (
                    <li key={i}>
                      <Link
                        to={`/shop/${item.id}`}
                        className="flex items-center my-[5px] px-[5px] hover:bg-[#ddd]"
                      >
                        <img
                          src={item.thumbnail}
                          alt={item.title}
